...
<div class="header">
    ...
    <div class="nav fr f16">
        ...
        <a href="<?php echo U('/question');?>" class="dr">常见问题</a>|
    	<a href="<?php echo U('/contact');?>">客服中心</a>|
    </div>
</div>
<!--banner-->
<div class="pbanner p03"></div>
<!--main-->
<div class="main">
        <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><dl class="question">
		<dt class="f14"><?php echo ($i); ?>.<?php echo ($row["title"]); ?>？</dt>
