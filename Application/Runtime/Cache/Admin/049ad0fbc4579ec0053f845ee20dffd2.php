...
<!--左边导航部分-->
    ...
    <div class="left fl">
        ...
        <div class="nav0">
            ...
            <a href="<?php echo U('Question/index');?>" class="dr7">常见问题</a>
        </div>
    </div>
...
<div class="right">
	...
	<div class="tit f20">常见问题<a class="f12 cursor" data-target="#myModal" data-toggle="modal">增加常见问题</a></div>
    <div class="con">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">增加常见问题</h4>
              </div>
              <div class="modal-body">
                <form id="form1" name="form1" method="post" action="<?php echo U('Admin/Question/add');?>"  enctype="multipart/form-data" >
...
<script>   
    ...
    function edit(demo){
        ...
        $.get(
            "<?php echo U('Question/modifyNewsInfo');?>" ,
            {id:memberId},
            function(data){
                $("#destination").html("");
    ...
    function sub(){
        ...
        $.post(
            "<?php echo U('Admin/Question/updateInfo');?>",
            $("#form2").serialize(),
            function(data){
                if(data==1){
                    alert("更新成功!");
                    location.href="<?php echo U('Question/index');?>";
                }else{
                    alert(data);
                    return;
                }
